module.exports.credentialsTemplate = (email, passowrd, isEmail) => {
                          ...
                          >
                            ...
                            >
                              <span style="color: #fd9800; font-size: 18px"
                                ><strong>Your Credentials</strong></span
                              >
                            </p>
                          </div>
                        </div>
                            ...
                            >
                              <span style="color: #2a272b"
                                ><span style="font-size: 16px"
                                  >Please refer below for login details.</span
                                ></span
                              >
                            </p>
                          </div>
                          ...
                          >
                            ...
                            >
                             <table border="2px" style='padding: 1rem; ' align='center' width="100%" cellpadding="0" cellspacing="0" >
                              <thead align='center'>
                                <th style='padding: 1rem; width:15px'>${
                                  isEmail ? 'Email' : 'Registration Number'
                                }</th>
                                <th style='padding: 1rem; width:15px'>Password</th>
                              </thead>
                           <tbody>
                        
                           <tr>
                               <th style='padding: 1rem;'>${email}</th>
                                  <th style='padding: 1rem;'>${passowrd}</th>      
                                </tr>
                              </tbody>
                            </table>
