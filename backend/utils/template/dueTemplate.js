module.exports.dueTemplate = (dues) => {
                          ...
                          >
                            ...
                            >
                             <table border="2px" style='padding: 1rem; ' align='center' width="100%" cellpadding="0" cellspacing="0" >
                              <thead align='center'>
                              <th style='padding: 1rem; width:3px'>Sr.#</th>
                                <th style='padding: 1rem; width:15px'>Department</th>
                                <th style='padding: 1rem; width:15px'>Due(in Rs)</th>
                                <th style='padding: 1rem; width:10px'>Description</th>
                              </thead>
                           <tbody>
